...
import xyz.drugalev.domain.service.TrainingServiceImpl;
...
public class TrainingTest {
    ...
    public void findAllTrainings() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            trainingService.save(new Training(new User("", ""), LocalDate.now(), new TrainingType("Test"), 1, 1));
            trainingService.save(new Training(new User("", ""), LocalDate.now(), new TrainingType("Test"), 1, 1));
        }
    ...
    public void findUserTrainings() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            trainingService.save(new Training(u1, LocalDate.now(), new TrainingType("Test"), 1, 1));
            trainingService.save(new Training(u2, LocalDate.now(), new TrainingType("Test"), 1, 1));
        }
    ...
    public void findUserTrainingsBetween() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            trainingService.save(new Training(u1, LocalDate.now().minusDays(i), new TrainingType("Test"), 1, 1));
            trainingService.save(new Training(u2, LocalDate.now(), new TrainingType("Test"), 1, 1));
        }
    ...
    public void deleteTraining() throws Exception {
        ...
        Training toDelete = new Training(new User("", ""), LocalDate.now(), new TrainingType("Test"), 1, 1);
        Training notToDelete = new Training(new User("", ""), LocalDate.now(), new TrainingType("Test"), 1, 1);
    ...
    public void getTrainingsStats() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            trainingService.save(new Training(u1, LocalDate.now().minusDays(i), new TrainingType("Test"), 5, 1));
            trainingService.save(new Training(u2, LocalDate.now(), new TrainingType("Test"), 1, 5));
        }

        Assertions.assertEquals(25, useCase.getTrainingsDuration(u1, LocalDate.now().minusDays(4), LocalDate.now()));
        Assertions.assertEquals(25, useCase.getTrainingsBurnedCalories(u2, LocalDate.now().minusDays(4), LocalDate.now()));
    ...
    public void successfulUpdateTrainings() throws Exception {
        ...
        User u = new User("", "");
        Training t = new Training(u, LocalDate.now(), new TrainingType("Test"), 1, 1);
